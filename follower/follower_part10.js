...
var util = require('util'),
    async = require('async');
var T = new twitter({
consumer_key: "oqLnnd6lYfe61uo3skSeC5Um2",
consumer_secret: "WnHibk9WTdzdKEbY57tbR5AeMy9x3UYnFeJti7k5KauQO2yU7z",
access_token: "2781882422-BLPPyy4ZxNX49pNuC0kHJkEnsph7qB9vE8bWs1f",
access_token_secret: "2WWaFDh2hP88KSr0X40J8GNUtTcolzDgwiFxSghCvO2HR"
...
var process_group = ['KimWellsMP','Bronwyn_Pike','TerryMulderMP','DavidHodgettMP',
                    'RussellNortheMP','SteveHerbertMP','DDrumMP','NatHutchins'];
...
var getAllFollowerID = function(politician, callback){
  ...
  setTimeout(function(){callback();}, 127000000 )
}
