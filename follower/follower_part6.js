...
var util = require('util'),
    async = require('async');
var T = new twitter({
consumer_key: "aNU2g3KhPYyyZspOIpz1FXDhE",
consumer_secret: "YEtBhWgNpXL0YFLOvtUA4YsiD2xzqif5by06pB2ZA3rshyZQdA",
access_token: "2781875101-a2beZ2zi1K1tOWJhiyjkYri5LZgueiTIb6o6Vpa",
access_token_secret: "97fqkkAzm7RERHPPjUDhEGkRC5Hvrr9e9PNcWqPh9HeMk"
...
var process_group = ['GavinJennings','JacintaAllanMP','JennyMikakos','DanielleGreenMP'];
...
var getAllFollowerID = function(politician, callback){
  ...
  setTimeout(function(){callback();}, 325000000 )
}
