...
var process_group = ['NickWakelingMP','RyanSmithMP','RichPhillipsMLC','HullsRob','sueMLC','JMaddenMP',
                     'heidivic','JohnLendersMP','Mary_Wooldridge'];
...
var getAllFollowerID = function(politician, callback){
  ...
  setTimeout(function(){callback();}, 162000000 )
}
