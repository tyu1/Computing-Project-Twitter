...
var util = require('util'),
    async = require('async');
var T = new twitter({
consumer_key: "yt1LigXmPHJ9o6DmlYGPLJR1B",
consumer_secret: "5lhP6nt3YiTg1hmhPLCzkPqfn9ipbQjcKdxxsVi72bMdieDArl",
access_token: "2781925483-yKlNyqSIsrFnbAzuhKkIE5jPJ7878KMjllrENgr",
access_token_secret: "jQieaxxGh9IJzZ3I7Me20PjLVQroV82sHuVamCBDUOANv"
...
var process_group = ['RichardsonFiona','ColleenHartland','LisanevilleMP','LouiseAsherMP','WendyLovellMP', 
                     'TimBullMP','LukeDonnellan','wadenoonan','AdemSomyurek','JPowellMP','ODonohueMLC'];
...
var getAllFollowerID = function(politician, callback){
  ...
  setTimeout(function(){callback();}, 85000000 )
}
