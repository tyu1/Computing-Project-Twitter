...
var util = require('util'),
    async = require('async');
var T = new twitter({
consumer_key: "cRuhtquC5YsXX8bXZgZpxiEVD",
consumer_secret: "DDgsUqOvAutxwLlQaqZnp8Q35oTgOgKG4f7bOWbYHTRtQlErio",
access_token: "2781901663-5Re5MHioLb8KQwU8gi8nRfHyPOrBGHZujrW5aIm",
access_token_secret: "xS5p8W9UX4r3nWCBZVWDWK7k68BzA3cWHgWzELJ78ZRed"
...
var process_group = ['RobertClarkMP','LilyDAmbrosioMP','impallas','JamesMerlinoMP'];
...
var getAllFollowerID = function(politician, callback){
  ...
  setTimeout(function(){callback();}, 250000000 )
}
